package tqm.bianfeng.com.tqm.baidumap.search;
...
import com.baidu.mapapi.model.LatLngBounds;import com.baidu.mapapi.search.core.CityInfo;
 ...
 * 演示poi搜索功能
 */
public class PoiSearchDemo extends FragmentActivity implements OnGetSuggestionResultListener,OnGetPoiSearchResultListener {
...
//        mPoiSearch.setOnGetPoiSearchResultListener(poiListener);//能返回结果
    ...
    public void onGetPoiResult(PoiResult result) {
        ...
        for (int i = 0; i < lenth; i++) {
            ...
            Log.e("Daniel","----onGetPoiResult---"+datas.get(i).address);
            Log.e("Daniel","----onGetPoiResult---"+datas.get(i).city);
            Log.e("Daniel","----onGetPoiResult---"+datas.get(i).name);
            Log.e("Daniel","----onGetPoiResult---"+datas.get(i).phoneNum);
            Log.e("Daniel","----onGetPoiResult---"+datas.get(i).postCode);
            Log.e("Daniel","----onGetPoiResult---"+datas.get(i).describeContents()+"");
            Log.e("Daniel","----onGetPoiResult---"+datas.get(i).hasCaterDetails+"");
            Log.e("Daniel","----onGetPoiResult---"+datas.get(i).isPano+"");
            Log.e("Daniel","----onGetPoiResult---"+datas.get(i).location.latitude+"");
            Log.e("Daniel","----onGetPoiResult---"+datas.get(i).location.latitudeE6+"");
            Log.e("Daniel","----onGetPoiResult---"+datas.get(i).type.name()+"");
        }
