...
//    }
    ...
    private WebChromeClient mWebChromeClient = new WebChromeClient() {
        ...
        public boolean onShowFileChooser(
            ...
            if (ContextCompat.checkSelfPermission(LoanOrActivityReleaseActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                    != PackageManager.PERMISSION_GRANTED) {
                //申请WRITE_EXTERNAL_STORAGE权限
                ActivityCompat.requestPermissions(LoanOrActivityReleaseActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},
