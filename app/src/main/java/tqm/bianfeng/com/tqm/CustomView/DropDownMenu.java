...
public class DropDownMenu extends LinearLayout {
    ...
    public OnClickLinsener getOnClickLinsener() {
        return onClickLinsener;
    }
    ...
    public void setTabTxtByIndex(String txt,int index){
        ((TextView)tabMenuView.getChildAt(index)).setText(txt);
    }
