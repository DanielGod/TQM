...
public class PhoneUtils {
     ...
     * @return
     */
    public static List<HashMap<String, String>> getPhoneContacts(Context mContext) {
        ArrayList<HashMap<String, String>> list = new ArrayList<HashMap<String, String>>();
        ...
        if (phoneCursor != null) {
            ...
            Cursor phoneCursorSim = resolver.query(uri, PHONES_PROJECTION, null, null, null);

            if (phoneCursorSim != null) {
                while (phoneCursorSim.moveToNext()) {

                    // 得到手机号码
                    String phoneNumber = phoneCursorSim.getString(phoneCursorSim.getColumnIndex(Contacts.People.NUMBER));
                    // 当手机号码为空的或者为空字段 跳过当前循环
                    if (StringUtils.isEmpty(phoneNumber))
                        continue;
                    // 得到联系人名称
                    String contactName = phoneCursorSim.getString(phoneCursorSim.getColumnIndex(Contacts.People.NAME));
                    //Sim卡中没有联系人头像
                    HashMap<String, String> map = new HashMap<String, String>();
                    map.put("phone", phoneNumber);
                    map.put("name", contactName);
    ...
    /**得到手机SIM卡联系人人信息**/
    public static List<HashMap<String, String>> getSIMContacts(Context mContext) {
        ContentResolver resolver = mContext.getContentResolver();
        ArrayList<HashMap<String, String>> list = new ArrayList<HashMap<String, String>>();
        // 获取Sims卡联系人
        Uri uri = Uri.parse("content://icc/adn");
        ...
        if (phoneCursor != null) {
            while (phoneCursor.moveToNext()) {
                ...
                // 得到手机号码
                String phoneNumber = phoneCursor.getString(phoneCursor.getColumnIndex(Contacts.People.NUMBER));
                // 当手机号码为空的或者为空字段 跳过当前循环
                if (StringUtils.isEmpty(phoneNumber))
                    continue;
                // 得到联系人名称
                String contactName = phoneCursor
                        .getString(phoneCursor.getColumnIndex(Contacts.People.NAME));
